...
KEEP extern const touchgfx::KerningNode kerning_Michroma_Regular_70_2bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x0054, -11 },  // (First char = [0x0054, T], Second char = [0x0041, A], Kerning dist = -11)
    { 0x0057, -5 },  // (First char = [0x0057, W], Second char = [0x0041, A], Kerning dist = -5)
    { 0x0059, -10 },  // (First char = [0x0059, Y], Second char = [0x0041, A], Kerning dist = -10)
    ...
    { 0x0057, -9 },  // (First char = [0x0057, W], Second char = [0x0061, a], Kerning dist = -9)
