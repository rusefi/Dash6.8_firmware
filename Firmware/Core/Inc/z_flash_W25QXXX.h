...
#define EXT_FLASH_SIZE			0X01000000	//4MB-32Mb	total size (bytes)
#define EXT_FLASH_PAGE_NUM		0x00004000	//16384		pages
#define EXT_FLASH_SECTOR_NUM	0x400		//1024 		sectors
